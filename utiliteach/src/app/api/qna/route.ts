...
export async function GET(
  ...
  const model = genAI.getGenerativeModel({
    ...
    systemInstruction:
      "Given a list of questions from students to a teacher. Delete the duplicates and similar questions. Return the list of questions in array format only and no other text.",
  });
